                ...
                {[
                  {
                    icon: 'Trophy',
                    title: '15+ лет опыта',
                    description: 'Успешно восстановили более 500 морских двигателей всех типов'
                  },
                  {
                    icon: 'CheckCircle',
                    title: 'Только оригинальные запчасти',
                    description: 'Работаем с официальными поставщиками Volvo Penta, Mercruiser, Indmar'
                  },
                  {
                    icon: 'Zap',
                    title: 'Экспресс-диагностика',
                    description: 'Полная диагностика двигателя за 2-4 часа с детальным отчетом'
                  },
                  {
                    icon: 'Star',
                    title: '100% гарантия качества',
                    description: 'Расширенная гарантия до 2 лет на все виды восстановительных работ'
                  },
                  {
                    icon: 'Wrench',
                    title: 'Современное оборудование',
                    description: 'Используем профессиональные стенды и диагностическое оборудование'
                  },
                  {
                    icon: 'Users',
                    title: 'Сертифицированные мастера',
                    description: 'Команда профессионалов с международными сертификатами производителей'
                  }
                ].map((item) => (
