...
const services = [
  {
    ...
    description: 'Комплексное восстановление морского двигателя с заменой всех изношенных компонентов и модернизацией систем',
  ...
  {
    id: 'repair',
    title: 'Ремонт морских двигателей',
    subtitle: 'Профессиональный ремонт',
    description: 'Диагностика и ремонт конкретных неисправностей морских двигателей любой сложности',
  ...
  {
    id: 'longblocks',
    title: 'Лонг-блоки для морских двигателей',
    subtitle: 'Готовые к установке',
    description: 'Готовые к установке лонг-блоки морских двигателей. Полностью восстановленные с гарантией качества',
  ...
  },
  {
    ...
    description: 'Полная компьютерная диагностика морских двигателей с выявлением всех неисправностей',
  ...
  },
  {
    ...
    description: 'Профессиональное форсирование морских двигателей с увеличением мощности и крутящего момента',
  ...
  },
  {
    ...
    description: 'Плановое техническое обслуживание морских двигателей для поддержания оптимальной работы',
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-primary/5 via-white to-marine-light/20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12">
            От диагностики до полного восстановления морских двигателей. 
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-primary/5 via-white to-marine-light/20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            Мы найдем решение для любой задачи по ремонту морских двигателей.
          </p>
