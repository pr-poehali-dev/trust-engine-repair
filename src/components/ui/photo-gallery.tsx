        ...
        <div className="space-y-2">
          ...
          >
            <img
              ...
              className="w-full h-full object-cover object-center transition-transform group-hover:scale-105 filter brightness-112 contrast-115 saturate-108 hue-rotate-2"
            />
      ...
      {selectedPhoto !== null && createPortal(
        ...
        >
          ...
          <img
            ...
            className="max-w-[calc(100vw-5rem)] max-h-[calc(100vh-5rem)] object-contain rounded-lg shadow-2xl filter brightness-112 contrast-115 saturate-108 hue-rotate-2"
