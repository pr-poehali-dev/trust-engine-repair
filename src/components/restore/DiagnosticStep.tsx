...
export default function DiagnosticStep({ photos }: DiagnosticStepProps) {
  return (
    <div className="w-full max-w-full overflow-hidden flex flex-col lg:flex-row items-start gap-4 md:gap-8">
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
              <div className="flex items-center gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  <CardTitle className="text-xl md:text-2xl font-bold text-gray-900 break-words">Первичная диагностика</CardTitle>
