...
export default function HeroSection({
  ...
  return (
    <section className="relative overflow-hidden pt-8 lg:pt-12">
      ...
      <div className="absolute z-1 top-20 right-10 w-32 h-32 bg-primary/35 rounded-3xl blur-md"></div>
      <div className="absolute z-1 bottom-40 left-20 w-36 h-36 bg-primary/30 rounded-2xl"></div>
      <div className="absolute z-1 top-1/4 left-1/3 w-32 h-32 bg-primary/30 rounded-xl"></div>
      <div className="absolute z-1 bottom-1/3 right-1/4 w-24 h-24 bg-primary/35 rounded-2xl"></div>
      <div className="absolute z-1 top-1/2 left-16 w-32 h-32 bg-primary/25 rounded-3xl blur-sm"></div>
      <div className="absolute z-1 bottom-1/4 right-1/3 w-24 h-24 bg-primary/30 rounded-lg"></div>
      <div className="absolute z-1 top-3/4 left-1/6 w-20 h-20 bg-primary/28 rounded-xl"></div>
      <div className="absolute z-1 top-10 left-2/3 w-36 h-36 bg-primary/30 rounded-3xl"></div>
      {/* Дополнительные элементы (+30%) */}
      <div className="absolute z-1 top-1/8 right-3/4 w-24 h-24 bg-primary/35 rounded-2xl"></div>
      <div className="absolute z-1 bottom-1/8 left-3/4 w-16 h-16 bg-primary/32 rounded-lg"></div>
      <div className="absolute z-1 top-5/6 right-1/8 w-28 h-28 bg-primary/30 rounded-xl"></div>
      {/* Крупные элементы в области заголовка - уменьшены до 50% */}
      <div className="absolute z-1 top-14 left-12 w-20 h-20 bg-primary/25 rounded-3xl"></div>
      <div className="absolute z-1 top-8 right-20 w-16 h-16 bg-primary/30 rounded-2xl"></div>
      <div className="absolute z-1 top-24 left-1/5 w-16 h-16 bg-primary/28 rounded-xl"></div>
      <div className="absolute z-1 top-18 right-2/5 w-12 h-12 bg-primary/35 rounded-lg"></div>
