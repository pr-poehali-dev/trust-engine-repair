...
export default function ServicesSection({ id }: ServicesSectionProps = {}) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute z-1 top-5 left-5 w-32 h-32 bg-primary/35 rounded-2xl"></div>
      <div className="absolute z-1 bottom-10 right-10 w-36 h-36 bg-primary/30 rounded-3xl blur-sm"></div>
      <div className="absolute z-1 top-1/3 right-1/5 w-24 h-24 bg-primary/28 rounded-xl"></div>
      <div className="absolute z-1 bottom-1/4 left-1/4 w-32 h-32 bg-primary/25 rounded-lg"></div>
      <div className="absolute z-1 top-2/3 left-8 w-32 h-32 bg-primary/30 rounded-3xl blur-md"></div>
      <div className="absolute z-1 top-1/4 right-1/3 w-24 h-24 bg-primary/35 rounded-2xl"></div>
      <div className="absolute z-1 bottom-2/3 left-2/3 w-20 h-20 bg-primary/30 rounded-lg"></div>
      <div className="absolute z-1 top-10 left-1/2 w-36 h-36 bg-primary/25 rounded-3xl blur-sm"></div>
      {/* Дополнительные элементы (+30%) */}
      <div className="absolute z-1 top-1/6 left-3/4 w-24 h-24 bg-primary/35 rounded-xl"></div>
      <div className="absolute z-1 bottom-1/5 right-2/5 w-20 h-20 bg-primary/33 rounded-2xl"></div>
      <div className="absolute z-1 top-4/5 left-1/8 w-28 h-28 bg-primary/30 rounded-lg"></div>
      {/* Крупные элементы в области заголовка */}
      <div className="absolute z-1 top-8 left-12 w-32 h-32 bg-primary/25 rounded-3xl"></div>
      <div className="absolute z-1 top-4 right-20 w-32 h-32 bg-primary/30 rounded-2xl blur-sm"></div>
      <div className="absolute z-1 top-16 left-1/4 w-28 h-28 bg-primary/28 rounded-xl"></div>
      <div className="absolute z-1 top-12 right-1/3 w-24 h-24 bg-primary/35 rounded-lg"></div>
