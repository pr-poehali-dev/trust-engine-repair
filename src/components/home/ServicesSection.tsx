...
export default function ServicesSection({ id }: ServicesSectionProps = {}) {
  ...
  return (
    <section id={id || "services"} className="relative overflow-hidden py-20 lg:py-28">
      ...
      <div className="absolute z-0 bottom-10 right-10 w-42 h-42 bg-[#0f29768c] rounded-3xl blur-xl"></div>
      <div className="absolute z-0 top-1/3 right-1/5 w-28 h-28 bg-primary/18 rounded-xl blur-md"></div>
      <div className="absolute z-0 bottom-1/4 left-1/4 w-32 h-32 bg-[#0f29768c] rounded-lg blur-sm"></div>
      <div className="absolute z-0 top-2/3 left-8 w-40 h-40 bg-primary/15 rounded-3xl blur-xl"></div>
      <div className="absolute z-0 top-1/4 right-1/3 w-24 h-24 bg-[#0f29768c] rounded-2xl blur-lg"></div>
      <div className="absolute z-0 bottom-2/3 left-2/3 w-20 h-20 bg-primary/20 rounded-lg blur-md"></div>
      <div className="absolute z-0 top-10 left-1/2 w-48 h-48 bg-[#0f29768c] rounded-3xl blur-xl"></div>
      {/* Дополнительные элементы (+30%) */}
      <div className="absolute z-0 top-1/6 left-3/4 w-26 h-26 bg-[#0f29768c] rounded-xl blur-md"></div>
      <div className="absolute z-0 bottom-1/5 right-2/5 w-22 h-22 bg-primary/23 rounded-2xl blur-sm"></div>
      <div className="absolute z-0 top-4/5 left-1/8 w-30 h-30 bg-[#0f29768c] rounded-lg blur-md"></div>
      ...
      <div className="absolute z-0 top-4 right-20 w-34 h-34 bg-[#0f29768c] rounded-2xl blur-xl"></div>
      <div className="absolute z-0 top-16 left-1/4 w-30 h-30 bg-primary/14 rounded-xl blur-lg"></div>
      <div className="absolute z-0 top-12 right-1/3 w-26 h-26 bg-[#0f29768c] rounded-lg blur-md"></div>
