...
export default function WhyUsSection({ id }: WhyUsSectionProps = {}) {
  ...
  return (
    <section id={id || "why-us"} className="relative pt-20 lg:pt-28">
      ...
      <div className="absolute z-0 top-1/3 left-1/8 w-32 h-32 bg-primary/8 rounded-xl blur-xl"></div>
      ...
      <div className="absolute z-0 top-1/4 left-1/3 w-24 h-24 bg-[#039fcb0d] rounded-xl blur-md"></div>
      ...
      <div className="absolute z-0 bottom-1/6 left-2/3 w-16 h-16 bg-primary/26 rounded-lg blur-md"></div>
      {/* Дополнительные элементы (+30%) */}
      <div className="absolute z-0 top-1/8 left-5/6 w-26 h-26 bg-[#039fcb0d] rounded-xl blur-md"></div>
      <div className="absolute z-0 bottom-1/8 left-5/6 w-20 h-20 bg-primary/27 rounded-2xl blur-sm"></div>
      ...
      <div className="absolute z-0 top-10 left-1/3 w-24 h-24 bg-[#039fcb0d] rounded-lg blur-md"></div>
