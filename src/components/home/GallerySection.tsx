  ...
  return (
    <section id="gallery" className="relative overflow-hidden py-20 lg:py-28">
      ...
      <div className="absolute inset-0">
        ...
        {/* Сферические пятна */}
        <div className="absolute top-20 left-12 w-80 h-80 bg-primary/8 rounded-full blur-3xl opacity-[0.25]"></div>
        <div className="absolute bottom-12 right-20 w-96 h-96 bg-primary/6 rounded-full blur-3xl opacity-[0.25]"></div>
      </div>
